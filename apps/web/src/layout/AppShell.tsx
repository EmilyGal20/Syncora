...
import { AppBar, Avatar, Badge, Box, Divider, Drawer, IconButton, InputBase, List, ListItemButton, ListItemIcon, ListItemText, Menu, MenuItem, Toolbar, Tooltip, Typography, useMediaQuery } from '@mui/material'
...
const width=248
const iconMap:Record<string,ElementType>={Dashboard:SpaceDashboard,CheckCircle:CheckCircleOutline,CalendarMonth,Groups,Campaign,AdminPanelSettings,Circle:CircleOutlined}
...
export function AppShell(){
  ...
  const nav=<Box sx={{height:'100%',display:'flex',flexDirection:'column'}}>
    ...
    <Divider/><Box sx={{px:2,pt:2,pb:1}}><Typography variant="caption" color="text.secondary">SYNCORA DEMO</Typography></Box>
